...
<table>
  ...
  <tr>
      ...
      <td>Servern påträffade ett oväntat tillstånd som gjorde att den inte kunde slutföra begäran.  I Marketo kan detta inkludera felaktigt formaterade URL:er för REST API-begäran.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Antalet anrop idag överskred prenumerationens kvot (återställs dagligen kl. 12:00 CST).&gt;Din kvot finns på menyn Admin-&gt;Webbtjänster. Du kan öka din kvot med din kontohanterare.</td>
    </tr>
    <tr>
