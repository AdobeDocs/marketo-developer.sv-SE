...
feature: SOAP
description: Marketo SOAP deleteMObjects för att ta bort Opportunity och OpportunityPersonRole, med XML för begäran och svar, kodexempel som returnerar DELETED UNCHANGED MISSLYCKADES.
...
Tar bort ett eller flera [MObjects](marketo-objects.md) och returnerar resultatet av åtgärden (DELETED, UNCHANGED, FAILED).

## Begäran

| Fältnamn | Obligatoriskt/valfritt | Beskrivning |
| --- | --- | --- |
| mObjectList->mObject->type | Obligatoriskt | Kan vara en av `Opportunity` eller `OpportunityPersonRole` |
| mObjectList->mObject->id | Obligatoriskt | ID för MObject som ska tas bort |
