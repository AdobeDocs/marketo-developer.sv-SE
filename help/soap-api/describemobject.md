...
feature: SOAP
description: Lär dig använda describeMObject i Marketo SOAP för att hämta metadata och fältattribut för ActivityRecord, LeadRecord, Opportunity och OpportunityPersonRole.
...
Den här funktionen returnerar metadata för Standard och Virtual MObjects. Den tar in Marketo-objektet som indata och returnerar de fältattribut som är kopplade till det objektet.

## Begäran

| Fältnamn | Obligatoriskt/valfritt | Beskrivning |
| --- | --- | --- |
| objectName | Obligatoriskt | Namnet på det MObject som du vill hämta metadata för. `objectName` kan vara något av: `ActivityRecord`, `LeadRecord`, `Opportunity`, `OpportunityPersonRole` |
