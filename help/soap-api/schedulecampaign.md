...
description: Använd scheduleCampaign för att köra Marketo batch Smart Campaigns nu eller senare, åsidosätta tokens, klona program och implementera via SOAP XML med PHP- och Java-exempel.
