...
title: getChannels
feature: SOAP
description: Läs om hur Marketo SOAP getChannels hämtar status för kanalförloppet, stegnummer och flaggor för lyckade resultat med XML-exempel för begäran och svar.
...
Den här funktionen hämtar följande information om en kanal som har konfigurerats i Marketo:

- Progressionsstatus
- Stegnummer för varje progressionsstatus
- Om en specifik status för förloppet har definierats som lyckad

Du kan hämta information om alla kanaler eller ange en viss lista med kanaler
