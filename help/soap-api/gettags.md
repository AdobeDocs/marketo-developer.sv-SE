...
Den här funktionen hämtar följande information om icke-kanalstaggar som har konfigurerats i Marketo.

- Taggtyp
- Taggvärde

Du kan hämta information om alla icke-kanaltaggar eller ange en specifik lista med taggar och/eller värden.
